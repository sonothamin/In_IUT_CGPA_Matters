...
int main()
{
    ...
    total++; if (testCompletedResult()) passed++;
    total++; if (testCompletedMarks()) passed++;
    total++; if (testIncompleteMarks()) passed++;
    total++; if (testIncompleteResult()) passed++;
    total++; if (testSortBySemester()) passed++;
    total++; if (testFilterBySemester()) passed++;
